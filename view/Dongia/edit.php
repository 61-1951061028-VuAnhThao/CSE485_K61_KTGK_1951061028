        ...
        <div class="row">
            ...
            <div class="col-md-8 ms-auto me-auto">
                ...
                <form class="row g-3 needs-validation" method="post" action="" novalidate>
                    <div class="col-md-12">
                        <label for="validationCustom01" class="form-label">Họ và tên đọc giả</label>
                        <input type="text" class="form-control" name="hovaten" id="validationCustom01" value="<?php echo isset($_POST['hovaten']) ? $_POST['bd_name'] : $BD['bd_name']?>" required>
                    </div>
                    <div>
                    ...
                    <div class="col-md-6">
                        <label for="validationCustom02" class="form-label">Nghề nhiệp</label>
                        <input type="text" class="form-control" name="namsinh" id="validationCustom02" value="<?php echo isset($_POST['nghenghiep']) ? $_POST['nghenghiep'] : $BD['nghenghiep']?>" required>
                    </div>
                    <div class="col-md-6">
